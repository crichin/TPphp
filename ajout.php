...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($_FILES['photo']['tmp_name'], $target)) {
        $sql = "INSERT INTO etudiants (matricule, nom, prenom, date_naissance, lieu_naissance, filiere, classe, contact, photo) VALUES ('$matricule', '$nom', '$prenom', '$date_naissance', '$lieu_naissance', '$filiere', '$classe', '$contact', '$photo')";
